...
!d.isNothing(a.style.transformProperty);this.isTouchSupported=this.isEventSupported("touchstart");this.isGestureSupported=this.isEventSupported("gesturestart")},_eventTagNames:{select:"input",change:"input",submit:"form",reset:"form",error:"img",load:"img",abort:"img"},isEventSupported:function(a){var c=document.createElement(this._eventTagNames[a]||"div"),b,a="on"+a;b=d.objectHasProperty(c,a);b||(c.setAttribute(a,"return;"),b=typeof c[a]==="function");return b}};d.Browser._detect()})(window,window.Code.Util);
...
"TimingFunction"]="";c[this._transitionPrefix+"Delay"]="";c[this._transformLabel]="";d.DOM.setStyle(a,c)}else d.isNothing(e.jQuery)||e.jQuery(a).stop(!0,!0)},fadeIn:function(a,c,b,f){d.DOM.getStyle(a,"opacity")>=1&&d.DOM.setStyle(a,"opacity",0);d.Browser.isCSSTransformSupported?this._applyTransition(a,"opacity",1,c,b,f):d.isNothing(e.jQuery)||e.jQuery(a).fadeTo(c,1,b)},fadeOut:function(a,c,b,f){d.Browser.isCSSTransformSupported?this._applyTransition(a,"opacity",0,c,b,f):e.jQuery(a).fadeTo(c,0,b)},
slideBy:function(a,c,b,f,h,j){var i={},c=d.coalesce(c,0),b=d.coalesce(b,0),j=d.coalesce(j,"ease-out");i[this._transitionPrefix+"Property"]="all";i[this._transitionPrefix+"Delay"]="0";f===0?(i[this._transitionPrefix+"Duration"]="",i[this._transitionPrefix+"TimingFunction"]=""):(i[this._transitionPrefix+"Duration"]=f+"ms",i[this._transitionPrefix+"TimingFunction"]=d.coalesce(j,"ease-out"),d.Events.add(a,this._transitionEndLabel,this._getTransitionEndHandler()));i[this._transformLabel]=d.Browser.is3dSupported?
"translate3d("+c+"px, "+b+"px, 0px)":"translate("+c+"px, "+b+"px)";if(!d.isNothing(h))a.cclallcallback=h;d.DOM.setStyle(a,i);f===0&&e.setTimeout(function(){this._leaveTransforms(a)}.bind(this),this._applyTransitionDelay)},resetTranslate:function(a){var c={};c[this._transformLabel]=c[this._transformLabel]=d.Browser.is3dSupported?"translate3d(0px, 0px, 0px)":"translate(0px, 0px)";d.DOM.setStyle(a,c)},_applyTransition:function(a,c,b,f,h,j){var i={},j=d.coalesce(j,"ease-in");i[this._transitionPrefix+
"Property"]=c;i[this._transitionPrefix+"Duration"]=f+"ms";i[this._transitionPrefix+"TimingFunction"]=j;i[this._transitionPrefix+"Delay"]="0";d.Events.add(a,this._transitionEndLabel,this._getTransitionEndHandler());d.DOM.setStyle(a,i);d.isNothing(h)||(a["ccl"+c+"callback"]=h);e.setTimeout(function(){d.DOM.setStyle(a,c,b)},this._applyTransitionDelay)},_onTransitionEnd:function(a){d.Events.remove(a.currentTarget,this._transitionEndLabel,this._getTransitionEndHandler());this._leaveTransforms(a.currentTarget)},
_leaveTransforms:function(a){var c=a.style[this._transitionPrefix+"Property"],b=c!==""?"ccl"+c+"callback":"cclallcallback",f,c=d.coalesce(a.style.webkitTransform,a.style.MozTransform,a.style.transform),h,j=e.parseInt(d.DOM.getStyle(a,"left"),0),i=e.parseInt(d.DOM.getStyle(a,"top"),0),g,l,k={};c!==""&&(c=d.Browser.is3dSupported?c.match(/translate3d\((.*?)\)/):c.match(/translate\((.*?)\)/),d.isNothing(c)||(h=c[1].split(", "),g=e.parseInt(h[0],0),l=e.parseInt(h[1],0)));k[this._transitionPrefix+"Property"]=
...
b)&&(this[b]=null)},initialize:function(b,f){var d,e,i;this.cache=b;this.settings=f;this.slideByEndHandler=this.onSlideByEnd.bind(this);this.imageLoadHandler=this.onImageLoad.bind(this);this.currentCacheIndex=0;this.isSlideshowActive=this.isSliding=!1;if(this.cache.images.length<3)this.settings.loop=!1;this.el=a.DOM.createElement("div",{"class":c.Carousel.CssClasses.carousel},"");a.DOM.setStyle(this.el,{display:"block",position:"absolute",left:0,top:0,overflow:"hidden",zIndex:this.settings.zIndex});
a.DOM.hide(this.el);this.contentEl=a.DOM.createElement("div",{"class":c.Carousel.CssClasses.content},"");a.DOM.setStyle(this.contentEl,{display:"block",position:"absolute",left:0,top:0});a.DOM.appendChild(this.contentEl,this.el);e=b.images.length<3?b.images.length:3;for(d=0;d<e;d++)i=a.DOM.createElement("div",{"class":c.Carousel.CssClasses.item+" "+c.Carousel.CssClasses.item+"-"+d},""),a.DOM.setAttribute(i,"style","float: left;"),a.DOM.setStyle(i,{display:"block",position:"relative",left:0,top:0,
...
!0;this.setTimeout();this.resetPosition();a.Events.fire(this,{type:c.Toolbar.EventTypes.onShow,target:this})},setTimeout:function(){if(this.settings.captionAndToolbarAutoHideDelay>0)this.clearTimeout(),this.timeout=e.setTimeout(this.fadeOut.bind(this),this.settings.captionAndToolbarAutoHideDelay)},clearTimeout:function(){if(!a.isNothing(this.timeout))e.clearTimeout(this.timeout),this.timeout=null},fadeOut:function(){this.clearTimeout();a.Events.fire(this,{type:c.Toolbar.EventTypes.onBeforeHide,target:this});a.Animation.fadeOut(this.toolbarEl,
...
slideTimingFunction:"ease-out",slideshowDelay:3E3,doubleTapSpeed:250,margin:20,imageScaleMethod:"fit",captionAndToolbarHide:!1,captionAndToolbarFlipPosition:!0,captionAndToolbarAutoHideDelay:0,captionAndToolbarOpacity:0.8,captionAndToolbarShowEmptyCaptions:!0,getToolbar:g.Toolbar.getToolbar,allowUserZoom:!0,allowRotationOnUserZoom:!1,maxUserZoom:5,minUserZoom:0.5,doubleTapZoomLevel:2.5,getImageSource:g.Cache.Functions.getImageSource,getImageCaption:g.Cache.Functions.getImageCaption,getImageMetaData:g.Cache.Functions.getImageMetaData,
...
a.Events.add(e,"mousewheel",this.mouseWheelHandler);a.Events.add(this.uiLayer,g.TouchElement.EventTypes.onTouch,this.uiLayerTouchHandler);a.Events.add(this.carousel,f.EventTypes.onSlideByEnd,this.carouselSlideByEndHandler);a.Events.add(this.carousel,f.EventTypes.onSlideshowStart,this.carouselSlideshowStartHandler);a.Events.add(this.carousel,f.EventTypes.onSlideshowStop,this.carouselSlideshowStopHandler);a.isNothing(this.toolbar)||(a.Events.add(this.toolbar,h.EventTypes.onTap,this.toolbarTapHandler),
...
this.carouselSlideshowStopHandler);this.settings.enableMouseWheel&&a.Events.remove(e,"mousewheel",this.mouseWheelHandler);a.isNothing(this.toolbar)||(a.Events.remove(this.toolbar,h.EventTypes.onTap,this.toolbarTapHandler),a.Events.remove(this.toolbar,h.EventTypes.onBeforeShow,this.toolbarBeforeShowHandler),a.Events.remove(this.toolbar,h.EventTypes.onShow,this.toolbarShowHandler),a.Events.remove(this.toolbar,h.EventTypes.onBeforeHide,this.toolbarBeforeHideHandler),a.Events.remove(this.toolbar,h.EventTypes.onHide,
this.toolbarHideHandler))},hide:function(){if(!this.settings.preventHide){this.removeEventHandlers();a.Events.fire(this,{type:g.EventTypes.onBeforeHide,target:this});this.uiLayer.dispose();this.uiLayer=null;if(!a.isNothing(this.toolbar))this.toolbar.dispose(),this.toolbar=null;this.carousel.dispose();this.carousel=null;a.DOM.removeClass(e.document.body,g.CssClasses.activeBody);this.documentOverlay.dispose();this.documentOverlay=null;g.unsetActivateInstance();a.Events.fire(this,{type:g.EventTypes.onHide,
...
this.resetPosition(),(this.toolbar.setCaption(this.currentIndex),this.toolbar.setToolbarStatus(this.currentIndex));a.Events.fire(this,{type:g.EventTypes.onDisplayImage,target:this,action:b.action,index:b.cacheIndex})},onToolbarTap:function(b){switch(b.action){case h.ToolbarAction.next:this.next();break;case h.ToolbarAction.previous:this.previous();break;case h.ToolbarAction.close:this.hide();break;case h.ToolbarAction.play:this.play()}a.Events.fire(this,{type:g.EventTypes.onToolbarTap,target:this,toolbarAction:b.action,
