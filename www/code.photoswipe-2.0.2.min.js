...
// version: 2.0.2
(function(e){if(!Function.prototype.bind)Function.prototype.bind=function(d){var a=[].slice,b=a.call(arguments,1),c=this,f=function(){},g=function(){return c.apply(this instanceof f?this:d||{},b.concat(a.call(arguments)))};f.prototype=c.prototype;g.prototype=new f;return g};if(typeof e.Code==="undefined")e.Code={};e.Code.Util={registerNamespace:function(){var d=arguments,a=null,b,c,f;for(b=0;b<d.length;b++){f=d[b];f=f.split(".");a=f[0];typeof e[a]==="undefined"&&(e[a]={});a=e[a];for(c=1;c<f.length;++c)a[f[c]]=
...
(function(e,d){d.extend(d,{Events:{add:function(a,b,c){this._checkHandlersProperty(a);b==="mousewheel"&&(b=this._normaliseMouseWheelType());typeof a.__eventHandlers[b]==="undefined"&&(a.__eventHandlers[b]=[]);a.__eventHandlers[b].push(c);this._isBrowserObject(a)&&a.addEventListener(b,c,!1)},remove:function(a,b,c){this._checkHandlersProperty(a);b==="mousewheel"&&(b=this._normaliseMouseWheelType());if(a.__eventHandlers[b]instanceof Array){var f,g,e=a.__eventHandlers[b];if(d.isNothing(c)){if(this._isBrowserObject(a))for(f=
0;f<e.length;f++)a.removeEventListener(b,e[f],!1);a.__eventHandlers[b]=[]}else{f=0;for(g=e.length;f<g;f++)if(e[f]===c){e.splice(f,1);break}this._isBrowserObject(a)&&a.removeEventListener(b,c,!1)}}},fire:function(a,b){var c,f,g,j,i=Array.prototype.slice.call(arguments).splice(2);b==="mousewheel"&&(b=this._normaliseMouseWheelType());if(this._isBrowserObject(a)){if(typeof b!=="string")throw"type must be a string for DOM elements";g=this._NATIVE_EVENTS[b];c=document.createEvent(g?"HTMLEvents":"UIEvents");
c[g?"initEvent":"initUIEvent"](b,!0,!0,e,1);if(i.length<1){a.dispatchEvent(c);return}}this._checkHandlersProperty(a);c=typeof b==="string"?{type:b}:b;if(!c.target)c.target=a;if(!c.type)throw Error("Event object missing 'type' property.");if(a.__eventHandlers[c.type]instanceof Array){g=a.__eventHandlers[c.type];i.unshift(c);c=0;for(f=g.length;c<f;c++)j=g[c],d.isNothing(j)||j.apply(a,i)}},getMousePosition:function(a){var b={x:0,y:0};if(a.pageX)b.x=a.pageX;else if(a.clientX)b.x=a.clientX+(document.documentElement.scrollLeft||
...
(function(e,d){d.extend(d,{DOM:{setData:function(a,b,c){d.DOM.setAttribute(a,"data-"+b,c)},getData:function(a,b,c){return d.DOM.getAttribute(a,"data-"+b,c)},removeData:function(a,b){d.DOM.removeAttribute(a,"data-"+b)},isChildOf:function(a,b){if(b===a)return!1;for(;a&&a!==b;)a=a.parentNode;return a===b},find:function(a,b){if(d.isNothing(b))b=e.document;var c=b.querySelectorAll(a),f=[],g;for(g=0;g<c.length;g++)f.push(c[g]);return f},createElement:function(a,b,c){var f,a=document.createElement(a);for(f in b)d.objectHasProperty(b,
...
slideBy:function(a,b,c,f,g,j){var i={},b=d.coalesce(b,0),c=d.coalesce(c,0),j=d.coalesce(j,"ease-out");i[this._transitionPrefix+"Property"]="all";i[this._transitionPrefix+"Delay"]="0";f===0?(i[this._transitionPrefix+"Duration"]="",i[this._transitionPrefix+"TimingFunction"]=""):(i[this._transitionPrefix+"Duration"]=f+"ms",i[this._transitionPrefix+"TimingFunction"]=d.coalesce(j,"ease-out"),d.Events.add(a,this._transitionEndLabel,this._getTransitionEndHandler()));i[this._transformLabel]=d.Browser.is3dSupported?
"translate3d("+b+"px, "+c+"px, 0px)":"translate("+b+"px, "+c+"px)";if(!d.isNothing(g))a.cclallcallback=g;d.DOM.setStyle(a,i);f===0&&e.setTimeout(function(){this._leaveTransforms(a)}.bind(this),this._applyTransitionDelay)},resetTranslate:function(a){var b={};b[this._transformLabel]=b[this._transformLabel]=d.Browser.is3dSupported?"translate3d(0px, 0px, 0px)":"translate(0px, 0px)";d.DOM.setStyle(a,b)},_applyTransition:function(a,b,c,f,g,j){var i={},j=d.coalesce(j,"ease-in");i[this._transitionPrefix+
"Property"]=b;i[this._transitionPrefix+"Duration"]=f+"ms";i[this._transitionPrefix+"TimingFunction"]=j;i[this._transitionPrefix+"Delay"]="0";d.Events.add(a,this._transitionEndLabel,this._getTransitionEndHandler());d.DOM.setStyle(a,i);d.isNothing(g)||(a["ccl"+b+"callback"]=g);e.setTimeout(function(){d.DOM.setStyle(a,b,c)},this._applyTransitionDelay)},_onTransitionEnd:function(a){d.Events.remove(a.currentTarget,this._transitionEndLabel,this._getTransitionEndHandler());this._leaveTransforms(a.currentTarget)},
_leaveTransforms:function(a){var b=a.style[this._transitionPrefix+"Property"],c=b!==""?"ccl"+b+"callback":"cclallcallback",f,b=d.coalesce(a.style.webkitTransform,a.style.MozTransform,a.style.transform),g,j=e.parseInt(d.DOM.getStyle(a,"left"),0),i=e.parseInt(d.DOM.getStyle(a,"top"),0),h,l,k={};b!==""&&(b=d.Browser.is3dSupported?b.match(/translate3d\((.*?)\)/):b.match(/translate\((.*?)\)/),d.isNothing(b)||(g=b[1].split(", "),h=e.parseInt(g[0],0),l=e.parseInt(g[1],0)));k[this._transitionPrefix+"Property"]=
"";k[this._transitionPrefix+"Duration"]="";k[this._transitionPrefix+"TimingFunction"]="";k[this._transitionPrefix+"Delay"]="";d.DOM.setStyle(a,k);e.setTimeout(function(){if(!d.isNothing(g))k={},k[this._transformLabel]="",k.left=j+h+"px",k.top=i+l+"px",d.DOM.setStyle(a,k);d.isNothing(a[c])||(f=a[c],delete a[c],f(a))}.bind(this),this._applyTransitionDelay)}}})})(window,window.Code.Util);
...
this.isLandscape=!1;this.imageEl=new e.Image;this.imageLoadHandler=this.onImageLoad.bind(this)},load:function(){this.imageEl.src.indexOf(this.src)>-1?a.Events.fire(this,{type:b.Image.EventTypes.onLoad,target:this}):(this.imageEl.isLoading=!0,this.imageEl.onload=this.imageLoadHandler,this.imageEl.src=this.src)},shrinkImage:function(){if(!a.isNothing(this.imageEl)&&this.imageEl.src.indexOf(this.src)>-1)this.imageEl.src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=",a.isNothing(this.imageEl.parentNode)||
...
c)&&(this[c]=null)},initialize:function(c,d){var e,j,i;this.cache=c;this.settings=d;this.slideByEndHandler=this.onSlideByEnd.bind(this);this.imageLoadHandler=this.onImageLoad.bind(this);this.currentCacheIndex=0;this.isSlideshowActive=this.isSliding=!1;if(this.cache.images.length<3)this.settings.loop=!1;this.el=a.DOM.createElement("div",{"class":b.Carousel.CssClasses.carousel},"");a.DOM.setStyle(this.el,{display:"block",position:"absolute",left:0,top:0,overflow:"hidden",zIndex:this.settings.zIndex});
a.DOM.hide(this.el);this.contentEl=a.DOM.createElement("div",{"class":b.Carousel.CssClasses.content},"");a.DOM.setStyle(this.contentEl,{display:"block",position:"absolute",left:0,top:0});a.DOM.appendChild(this.contentEl,this.el);j=c.images.length<3?c.images.length:3;for(e=0;e<j;e++)i=a.DOM.createElement("div",{"class":b.Carousel.CssClasses.item+" "+b.Carousel.CssClasses.item+"-"+e},""),a.DOM.setAttribute(i,"style","float: left;"),a.DOM.setStyle(i,{display:"block",position:"relative",left:0,top:0,
overflow:"hidden"}),this.settings.margin>0&&a.DOM.setStyle(i,{marginRight:this.settings.margin+"px"}),a.DOM.appendChild(i,this.contentEl);a.DOM.appendToBody(this.el)},resetPosition:function(){var c=a.DOM.windowWidth(),d=a.DOM.windowHeight(),e=this.settings.margin>0?c+this.settings.margin:c,j=a.DOM.find("."+b.Carousel.CssClasses.item,this.contentEl);e*=j.length;var i;a.DOM.setStyle(this.el,{top:a.DOM.windowScrollTop()+"px",width:c,height:d});a.DOM.setStyle(this.contentEl,{width:e,height:d});for(e=
0;e<j.length;e++)i=j[e],a.DOM.setStyle(i,{width:c,height:d}),i=a.DOM.find("img",i)[0],a.isNothing(i)||this.resetImagePosition(i);this.setContentLeftPosition()},resetImagePosition:function(c){if(!a.isNothing(c)){a.DOM.getAttribute(c,"src");var b,d,e,i=a.DOM.width(this.el),h=a.DOM.height(this.el);this.settings.imageScaleMethod==="fitNoUpscale"?(d=c.naturalWidth,e=c.naturalHeight,d>i&&(b=i/d,d=Math.round(d*b),e=Math.round(e*b)),e>h&&(b=h/e,e=Math.round(e*b),d=Math.round(d*b))):(b=c.isLandscape?i/c.naturalWidth:
h/c.naturalHeight,d=Math.round(c.naturalWidth*b),e=Math.round(c.naturalHeight*b),this.settings.imageScaleMethod==="zoom"?(b=1,e<h?b=h/e:d<i&&(b=i/d),b!==1&&(d=Math.round(d*b),e=Math.round(e*b))):this.settings.imageScaleMethod==="fit"&&(b=1,d>i?b=i/d:e>h&&(b=h/e),b!==1&&(d=Math.round(d*b),e=Math.round(e*b))));a.DOM.setStyle(c,{position:"absolute",width:d,height:e,top:Math.round((h-e)/2)+"px",left:Math.round((i-d)/2)+"px",display:"block"})}},setContentLeftPosition:function(){var c=a.DOM.windowWidth(),
...
onCaptionAndToolbarShow:"PhotoSwipeOnCaptionAndToolbarShow",onBeforeCaptionAndToolbarHide:"PhotoSwipeOnBeforeCaptionAndToolbarHide",onCaptionAndToolbarHide:"PhotoSwipeOnCaptionAndToolbarHide",onToolbarTap:"PhotoSwipeOnToolbarTap"};a.instances=[];a.activeInstance=null;a.setActivateInstance=function(b){if(!d.isNothing(a.activeInstance))throw"Code.PhotoSwipe.activateInstance: Unable to active instance as another instance is already active";a.activeInstance=b};a.unsetActivateInstance=function(){a.activeInstance=
null};a.attach=function(b,c,e){for(var g,e=a.createInstance(b,c,e),c=0;c<b.length;c++)if(g=b[c],!d.isNothing(g.nodeType)&&g.nodeType===1)g.__photoSwipeClickHandler=a.onTriggerElementClick.bind(e),d.Events.remove(g,"click",g.__photoSwipeClickHandler),d.Events.add(g,"click",g.__photoSwipeClickHandler);return e};if(e.jQuery)e.jQuery.fn.photoSwipe=function(b,c){return a.attach(this,b,c)};a.detatch=function(b){var c,e;for(c=0;c<b.originalImages.length;c++)e=b.originalImages[c],!d.isNothing(e.nodeType)&&
e.nodeType===1&&(d.Events.remove(e,"click",e.__photoSwipeClickHandler),delete e.__photoSwipeClickHandler);a.disposeInstance(b)};a.createInstance=function(b,c,e){var g;if(d.isNothing(b))throw"Code.PhotoSwipe.attach: No images passed.";if(!d.isLikeArray(b))throw"Code.PhotoSwipe.createInstance: Images must be an array of elements or image urls.";if(b.length<1)throw"Code.PhotoSwipe.createInstance: No images to passed.";c=d.coalesce(c,{});g=a.getInstance(e);if(d.isNothing(g))g=new a.PhotoSwipeClass(b,
c,e),a.instances.push(g);else throw'Code.PhotoSwipe.createInstance: Instance with id "'+e+' already exists."';return g};a.disposeInstance=function(b){var c=a.getInstanceIndex(b);if(c<0)throw"Code.PhotoSwipe.disposeInstance: Unable to find instance to dispose.";b.dispose();a.instances.splice(c,1)};a.onTriggerElementClick=function(a){a.preventDefault();this.show(a.currentTarget)};a.getInstance=function(b){var c,d;for(c=0;c<a.instances.length;c++)if(d=a.instances[c],d.id===b)return d;return null};a.getInstanceIndex=
function(b){var c,d=-1;for(c=0;c<a.instances.length;c++)if(a.instances[c]===b){d=c;break}return d}})(window,window.Code.Util);
(function(e,d,a,b,c,f,g,j,i){a.registerNamespace("Code.PhotoSwipe");var h=e.Code.PhotoSwipe;h.PhotoSwipeClass=d({id:null,settings:null,isBackEventSupported:null,backButtonClicked:null,currentIndex:null,originalImages:null,mouseWheelStartTime:null,cache:null,documentOverlay:null,carousel:null,uiLayer:null,toolbar:null,zoomPanRotate:null,windowOrientationChangeHandler:null,windowScrollHandler:null,windowHashChangeHandler:null,keyDownHandler:null,windowOrientationEventName:null,uiLayerTouchHandler:null,
carouselSlideByEndHandler:null,carouselSlideshowStartHandler:null,carouselSlideshowStopHandler:null,toolbarTapHandler:null,toolbarBeforeShowHandler:null,toolbarShowHandler:null,toolbarBeforeHideHandler:null,toolbarHideHandler:null,mouseWheelHandler:null,dispose:function(){var b;a.Events.remove(this,h.EventTypes.onBeforeShow);a.Events.remove(this,h.EventTypes.onShow);a.Events.remove(this,h.EventTypes.onBeforeHide);a.Events.remove(this,h.EventTypes.onHide);a.Events.remove(this,h.EventTypes.onDisplayImage);
a.Events.remove(this,h.EventTypes.onResetPosition);a.Events.remove(this,h.EventTypes.onSlideshowStart);a.Events.remove(this,h.EventTypes.onSlideshowStop);a.Events.remove(this,h.EventTypes.onTouch);a.Events.remove(this,h.EventTypes.onBeforeCaptionAndToolbarShow);a.Events.remove(this,h.EventTypes.onCaptionAndToolbarShow);a.Events.remove(this,h.EventTypes.onBeforeCaptionAndToolbarHide);a.Events.remove(this,h.EventTypes.onCaptionAndToolbarHide);this.removeEventHandlers();a.isNothing(this.documentOverlay)||
this.documentOverlay.dispose();a.isNothing(this.carousel)||this.carousel.dispose();a.isNothing(this.uiLayer)||this.uiLayer.dispose();a.isNothing(this.toolbar)||this.toolbar.dispose();this.destroyZoomPanRotate();a.isNothing(this.cache)||this.cache.dispose();for(b in this)a.objectHasProperty(this,b)&&(this[b]=null)},initialize:function(c,d,f){this.id=a.isNothing(f)?"PhotoSwipe"+(new Date).getTime().toString():f;this.originalImages=c;if(a.Browser.isAndroid&&e.navigator.userAgent.indexOf("2.1")>-1)this.isBackEventSupported=
...
slideTimingFunction:"ease-out",slideshowDelay:3E3,doubleTapSpeed:250,margin:20,imageScaleMethod:"fit",captionAndToolbarHide:!1,captionAndToolbarFlipPosition:!0,captionAndToolbarAutoHideDelay:0,captionAndToolbarOpacity:0.8,captionAndToolbarShowEmptyCaptions:!0,getToolbar:h.Toolbar.getToolbar,allowUserZoom:!0,allowRotationOnUserZoom:!1,maxUserZoom:5,minUserZoom:0.5,doubleTapZoomLevel:2.5,getImageSource:h.Cache.Functions.getImageSource,getImageCaption:h.Cache.Functions.getImageCaption,getImageMetaData:h.Cache.Functions.getImageMetaData,
cacheMode:h.Cache.Mode.normal};a.extend(this.settings,d);if(this.settings.preventHide)this.settings.backButtonHideEnabled=!1;this.cache=new b.CacheClass(c,this.settings)},show:function(b){var c;if(a.isNumber(b))this.currentIndex=b;else{this.currentIndex=-1;for(c=0;c<this.originalImages.length;c++)if(this.originalImages[c]===b){this.currentIndex=c;break}}if(this.currentIndex<0||this.currentIndex>this.originalImages.length-1)throw"Code.PhotoSwipe.PhotoSwipeClass.show: Starting index out of range";h.setActivateInstance(this);
a.DOM.addClass(e.document.body,h.CssClasses.buildingBody);this.createComponents();a.Events.fire(this,{type:h.EventTypes.onBeforeShow,target:this});this.documentOverlay.fadeIn(this.settings.fadeInSpeed,this.onDocumentOverlayFadeIn.bind(this))},createComponents:function(){this.documentOverlay=new c.DocumentOverlayClass(this.settings);this.carousel=new f.CarouselClass(this.cache,this.settings);this.uiLayer=new j.UILayerClass(this.settings);if(!this.settings.captionAndToolbarHide)this.toolbar=new g.ToolbarClass(this.cache,
this.settings)},resetPosition:function(){this.destroyZoomPanRotate();this.documentOverlay.resetPosition();this.carousel.resetPosition();a.isNothing(this.toolbar)||this.toolbar.resetPosition();this.uiLayer.resetPosition();a.Events.fire(this,{type:h.EventTypes.onResetPosition,target:this})},addEventHandler:function(b,c){a.Events.add(this,b,c)},addEventHandlers:function(){if(a.isNothing(this.windowOrientationChangeHandler))this.windowOrientationChangeHandler=this.onWindowOrientationChange.bind(this),
...
a.Events.add(e,"mousewheel",this.mouseWheelHandler);a.Events.add(this.uiLayer,h.TouchElement.EventTypes.onTouch,this.uiLayerTouchHandler);a.Events.add(this.carousel,f.EventTypes.onSlideByEnd,this.carouselSlideByEndHandler);a.Events.add(this.carousel,f.EventTypes.onSlideshowStart,this.carouselSlideshowStartHandler);a.Events.add(this.carousel,f.EventTypes.onSlideshowStop,this.carouselSlideshowStopHandler);a.isNothing(this.toolbar)||(a.Events.add(this.toolbar,g.EventTypes.onTap,this.toolbarTapHandler),
a.Events.add(this.toolbar,g.EventTypes.onBeforeShow,this.toolbarBeforeShowHandler),a.Events.add(this.toolbar,g.EventTypes.onShow,this.toolbarShowHandler),a.Events.add(this.toolbar,g.EventTypes.onBeforeHide,this.toolbarBeforeHideHandler),a.Events.add(this.toolbar,g.EventTypes.onHide,this.toolbarHideHandler))},removeEventHandlers:function(){a.Events.remove(e,this.orientationEventName,this.windowOrientationChangeHandler);a.Events.remove(e,"scroll",this.windowScrollHandler);this.settings.enableKeyboard&&
a.Events.remove(e.document,"keydown",this.keyDownHandler);this.isBackEventSupported&&this.settings.backButtonHideEnabled&&a.Events.remove(e,"hashchange",this.windowHashChangeHandler);a.Events.remove(this.uiLayer,h.TouchElement.EventTypes.onTouch,this.uiLayerTouchHandler);a.Events.remove(this.carousel,f.EventTypes.onSlideByEnd,this.carouselSlideByEndHandler);a.Events.remove(this.carousel,f.EventTypes.onSlideshowStart,this.carouselSlideshowStartHandler);a.Events.remove(this.carousel,f.EventTypes.onSlideshowStop,
this.carouselSlideshowStopHandler);this.settings.enableMouseWheel&&a.Events.remove(e,"mousewheel",this.mouseWheelHandler);a.isNothing(this.toolbar)||(a.Events.remove(this.toolbar,g.EventTypes.onTap,this.toolbarTapHandler),a.Events.remove(this.toolbar,g.EventTypes.onBeforeShow,this.toolbarBeforeShowHandler),a.Events.remove(this.toolbar,g.EventTypes.onShow,this.toolbarShowHandler),a.Events.remove(this.toolbar,g.EventTypes.onBeforeHide,this.toolbarBeforeHideHandler),a.Events.remove(this.toolbar,g.EventTypes.onHide,
this.toolbarHideHandler))},hide:function(){if(!this.settings.preventHide){this.removeEventHandlers();a.Events.fire(this,{type:h.EventTypes.onBeforeHide,target:this});this.uiLayer.dispose();this.uiLayer=null;if(!a.isNothing(this.toolbar))this.toolbar.dispose(),this.toolbar=null;this.carousel.dispose();this.carousel=null;a.DOM.removeClass(e.document.body,h.CssClasses.activeBody);this.documentOverlay.dispose();this.documentOverlay=null;h.unsetActivateInstance();a.Events.fire(this,{type:h.EventTypes.onHide,
...
onDocumentOverlayFadeIn:function(){e.setTimeout(function(){a.DOM.removeClass(e.document.body,h.CssClasses.buildingBody);a.DOM.addClass(e.document.body,h.CssClasses.activeBody);this.addEventHandlers();this.carousel.show(this.currentIndex);this.uiLayer.show();this.settings.autoStartSlideshow?this.play():a.isNothing(this.toolbar)||this.toolbar.show(this.currentIndex);a.Events.fire(this,{type:h.EventTypes.onShow,target:this})}.bind(this),250)},onWindowScroll:function(){this.resetPosition()},onWindowOrientationChange:function(){this.resetPosition()},
...
a.keyCode===13&&(a.preventDefault(),this.play())},onUILayerTouch:function(b){if(this.isZoomActive())switch(b.action){case h.TouchElement.ActionTypes.gestureChange:this.zoomPanRotate.zoomRotate(b.scale,this.settings.allowRotationOnUserZoom?b.rotation:0);break;case h.TouchElement.ActionTypes.gestureEnd:this.zoomPanRotate.setStartingScaleAndRotation(b.scale,this.settings.allowRotationOnUserZoom?b.rotation:0);break;case h.TouchElement.ActionTypes.touchStart:this.zoomPanRotate.panStart(b.point);break;
case h.TouchElement.ActionTypes.touchMove:this.zoomPanRotate.pan(b.point);break;case h.TouchElement.ActionTypes.doubleTap:this.destroyZoomPanRotate();this.toggleToolbar();break;case h.TouchElement.ActionTypes.swipeLeft:this.destroyZoomPanRotate();this.next();this.toggleToolbar();break;case h.TouchElement.ActionTypes.swipeRight:this.destroyZoomPanRotate(),this.previous(),this.toggleToolbar()}else switch(b.action){case h.TouchElement.ActionTypes.touchMove:case h.TouchElement.ActionTypes.swipeLeft:case h.TouchElement.ActionTypes.swipeRight:this.fadeOutToolbarIfVisible();
this.carousel.onTouch(b.action,b.point);break;case h.TouchElement.ActionTypes.touchStart:case h.TouchElement.ActionTypes.touchEnd:this.carousel.onTouch(b.action,b.point);break;case h.TouchElement.ActionTypes.tap:this.toggleToolbar();break;case h.TouchElement.ActionTypes.doubleTap:b.point.x-=a.DOM.windowScrollLeft();b.point.y-=a.DOM.windowScrollTop();var c=this.cache.images[this.currentIndex].imageEl,d=e.parseInt(a.DOM.getStyle(c,"top"),10),f=e.parseInt(a.DOM.getStyle(c,"left"),10),g=f+a.DOM.width(c),
c=d+a.DOM.height(c);if(b.point.x<f)b.point.x=f;else if(b.point.x>g)b.point.x=g;if(b.point.y<d)b.point.y=d;else if(b.point.y>c)b.point.y=c;this.createZoomPanRotate();this.isZoomActive()&&this.zoomPanRotate.zoomAndPanToPoint(this.settings.doubleTapZoomLevel,b.point);break;case h.TouchElement.ActionTypes.gestureStart:this.createZoomPanRotate()}a.Events.fire(this,{type:h.EventTypes.onTouch,target:this,point:b.point,action:b.action})},onCarouselSlideByEnd:function(b){this.currentIndex=b.cacheIndex;a.isNothing(this.toolbar)||
(this.toolbar.setCaption(this.currentIndex),this.toolbar.setToolbarStatus(this.currentIndex));a.Events.fire(this,{type:h.EventTypes.onDisplayImage,target:this,action:b.action,index:b.cacheIndex})},onToolbarTap:function(b){switch(b.action){case g.ToolbarAction.next:this.next();break;case g.ToolbarAction.previous:this.previous();break;case g.ToolbarAction.close:this.hide();break;case g.ToolbarAction.play:this.play()}a.Events.fire(this,{type:h.EventTypes.onToolbarTap,target:this,toolbarAction:b.action,
tapTarget:b.tapTarget})},onMouseWheel:function(b){var c=a.Events.getWheelDelta(b);if(!(b.timeStamp-(this.mouseWheelStartTime||0)<this.settings.mouseWheelSpeed))this.mouseWheelStartTime=b.timeStamp,this.settings.invertMouseWheel&&(c*=-1),c<0?this.next():c>0&&this.previous()},onCarouselSlideshowStart:function(){a.Events.fire(this,{type:h.EventTypes.onSlideshowStart,target:this})},onCarouselSlideshowStop:function(){a.Events.fire(this,{type:h.EventTypes.onSlideshowStop,target:this})},onToolbarBeforeShow:function(){a.Events.fire(this,
{type:h.EventTypes.onBeforeCaptionAndToolbarShow,target:this})},onToolbarShow:function(){a.Events.fire(this,{type:h.EventTypes.onCaptionAndToolbarShow,target:this})},onToolbarBeforeHide:function(){a.Events.fire(this,{type:h.EventTypes.onBeforeCaptionAndToolbarHide,target:this})},onToolbarHide:function(){a.Events.fire(this,{type:h.EventTypes.onCaptionAndToolbarHide,target:this})}})})(window,window.klass,window.Code.Util,window.Code.PhotoSwipe.Cache,window.Code.PhotoSwipe.DocumentOverlay,window.Code.PhotoSwipe.Carousel,
window.Code.PhotoSwipe.Toolbar,window.Code.PhotoSwipe.UILayer,window.Code.PhotoSwipe.ZoomPanRotate);